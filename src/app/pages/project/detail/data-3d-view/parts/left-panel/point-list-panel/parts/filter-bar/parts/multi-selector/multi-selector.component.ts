...
@Component({
  selector:
    'ntc-project-detail-data-3d-view-parts-point-list-panel-filter-bar-multi-selector',
  templateUrl: './multi-selector.component.html',
  styleUrls: ['./multi-selector.component.scss'],
})
export class MultiSelectorComponent extends BaseComponent implements OnChanges {
  @Input() label: string = '';
